...
} Motor3508_t,Motor2006_t;

// p轴
typedef struct
{
	Motor2006_t pitch_motor;
	Encoder_t *pitch_motor_encoder;
	pid_parameter_t pitch_motor_speed_pid;
	pid_parameter_t pitch_motor_position_pid;
	pid_parameter_t pitch_motor_auto_speed_pid;
	pid_parameter_t pitch_motor_auto_position_pid;
